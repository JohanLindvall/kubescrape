...
const (
	...
	flagsBeginMark = "<!-- BEGIN GENERATED: kubescrape flags -->"
	flagsEndMark   = "<!-- END GENERATED: kubescrape flags -->"
)
...
func TestFlagsDocIsCurrent(t *testing.T) {
	...
	table := docscheck.FlagTable(flag.CommandLine, "update-flags-doc")
...
func TestFlagsAreMentionedInConfigurationDoc(t *testing.T) {
	...
	flag.CommandLine.VisitAll(func(f *flag.Flag) {
		if f.Name == "update-flags-doc" || strings.HasPrefix(f.Name, "test.") {
			return
		}
